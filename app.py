...
MODEL_NAME = 'homework_clustering_pipeline_v1'
...
st.header("Jak Pracują")
st.markdown(predicted_cluster_data['working_style'])
st.header("Jak ich wołają inni programiści")
st.markdown(predicted_cluster_data['funny_description'])
st.header("Gdzie najlepiej się im pracuje")
st.markdown(predicted_cluster_data['work_place'])
st.header("Profil psychologiczny")
st.markdown(predicted_cluster_data['psycho_profile'])
st.header("Podobni tobie na kursie")
